...
#include <Library/MsSecureBootLib.h>             // Our header
#include <Library/PlatformKeyLib.h>              // Project-Specific PKs

#include <Protocol/VariablePolicy.h>

#include "MsSecureBootDefaultVars.h"             // Byte arrays of the default keys.
  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, "MsSecureBootLib::%a()\n", __FUNCTION__));
  ...
  Status   = InstallSecureBootVariable (
               EFI_IMAGE_SECURITY_DATABASE1,
               &gEfiImageSecurityDatabaseGuid,
               DataSize,
               Data
